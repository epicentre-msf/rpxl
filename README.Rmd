...
[![Codecov test coverage](https://codecov.io/gh/epicentre-msf/rpxl/branch/main/graph/badge.svg)](https://app.codecov.io/gh/epicentre-msf/rpxl?branch=main)
<!-- badges: end -->
...
Read password-protected .xlsx files with function `rp_xlsx()`, a wrapper to
...
`decrypt_wb()`. The function returns the path to the decrypted file, which
